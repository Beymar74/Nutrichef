...
<?php $__env->startSection('titulo_pagina', 'Catálogos y Parámetros'); ?>
...
<?php $__env->startSection('contenido'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <?php $__currentLoopData = $dominios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dominio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden flex flex-col h-full hover:shadow-md transition-shadow">
                ...
                <div class="p-4 flex-1 overflow-y-auto max-h-64 space-y-2 custom-scrollbar">
                    <?php $__empty_1 = true; $__currentLoopData = $dominio->subdominios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex justify-between items-center group p-2 hover:bg-slate-50 rounded-lg transition-colors border border-transparent hover:border-slate-100">
                            <span class="text-sm text-slate-600 font-medium"><?php echo e($sub->descripcion); ?></span>
                            
                            <!-- Botón Eliminar -->
                            <!-- CORRECCIÓN: Agregado el prefijo 'admin.' a la ruta -->
                            <form action="<?php echo e(route('admin.configuracion.subdominio.destroy', $sub->id)); ?>" method="POST" class="opacity-0 group-hover:opacity-100 transition-opacity">
                                <?php echo csrf_field(); ?> 
                ...
                <div class="p-3 border-t border-slate-100 bg-slate-50/30">
                    <!-- CORRECCIÓN: Agregado el prefijo 'admin.' a la ruta -->
                    <form action="<?php echo e(route('admin.configuracion.subdominio.store')); ?>" method="POST" class="flex gap-2">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="id_dominio" value="<?php echo e($dominio->id); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/configuracion/index.blade.php ENDPATH**/ ?>