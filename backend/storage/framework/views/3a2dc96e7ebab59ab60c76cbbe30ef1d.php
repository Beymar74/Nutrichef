...
<?php $__env->startSection('titulo_pagina', 'Resumen General'); ?>

<?php $__env->startSection('contenido'); ?>
    <!-- Bienvenida -->
    <div class="mb-8 flex justify-between items-end">
        <div>
            <h1 class="text-2xl font-bold text-slate-800">¡Hola, <?php echo e(Auth::user()->name); ?>!</h1>
    ...
    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-xl border border-slate-100 hover:shadow-md transition-shadow">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="flex items-baseline">
                                <div class="text-2xl font-bold text-slate-800"><?php echo e($totalUsuarios); ?></div>
                                <div class="ml-2 flex items-baseline text-xs font-semibold text-emerald-600">
                                    <?php echo e($usuariosActivos); ?> activos
                                </div>
                            </dd>
                        </dl>
                    </div>
            ...
            <div class="bg-slate-50 px-5 py-2 border-t border-slate-100">
                <a href="<?php echo e(route('admin.usuarios.index')); ?>" class="text-xs font-medium text-calabaza-600 hover:text-calabaza-800 flex items-center">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-bold text-slate-800"><?php echo e($recetasPublicadas); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
            <div class="bg-slate-50 px-5 py-2 border-t border-slate-100">
                <a href="<?php echo e(route('admin.recetas.index', ['estado' => 'aprobada'])); ?>" class="text-xs font-medium text-emerald-600 hover:text-emerald-800 flex items-center">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-bold text-slate-800"><?php echo e($recetasPendientes); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
            <div class="bg-slate-50 px-5 py-2 border-t border-slate-100">
                <a href="<?php echo e(route('admin.recetas.index', ['estado' => 'pendiente'])); ?>" class="text-xs font-medium text-calabaza-600 hover:text-calabaza-800 flex items-center">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-bold text-slate-800"><?php echo e($recetasRechazadas); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
            <div class="bg-slate-50 px-5 py-2 border-t border-slate-100">
                <a href="<?php echo e(route('admin.recetas.index', ['estado' => 'rechazada'])); ?>" class="text-xs font-medium text-red-600 hover:text-red-800 flex items-center">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white shadow-sm rounded-xl border border-slate-100 p-6">
            ...
            <div class="space-y-4">
                <?php $__empty_1 = true; $__currentLoopData = $ultimasRecetas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $receta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between p-3 hover:bg-slate-50 rounded-lg transition-colors border border-transparent hover:border-slate-100">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="w-10 h-10 rounded-lg bg-slate-100 overflow-hidden flex-shrink-0">
                                <?php $img = $receta->multimedia->first(); ?>
                                <?php if($img): ?>
                                    <img src="<?php echo e(\Illuminate\Support\Str::startsWith($img->archivo, 'http') ? $img->archivo : asset('storage/'.$img->archivo)); ?>" class="w-full h-full object-cover">
                                <?php else: ?>
                            ...
                            <!-- Info -->
                            <div>
                                <p class="text-sm font-bold text-slate-800 line-clamp-1"><?php echo e($receta->titulo); ?></p>
                                <p class="text-xs text-slate-500">Por <?php echo e($receta->creador->name ?? 'Anónimo'); ?></p>
                            </div>
                        </div>
                        <!-- Estado -->
                        <?php
                        ...
                        ?>
                        <span class="px-2 py-1 rounded text-xs font-bold <?php echo e($color); ?>">
                            <?php echo e($estado == 'BORRADOR' ? 'APROBADA' : $estado); ?>
            ...
            <a href="<?php echo e(route('admin.recetas.index')); ?>" class="block mt-4 text-center text-sm font-medium text-calabaza-600 hover:text-calabaza-700">
        ...
        <div class="bg-white shadow-sm rounded-xl border border-slate-100 p-6 h-fit">
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="<?php echo e(route('admin.usuarios.create')); ?>" class="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-200 hover:border-calabaza-300 hover:bg-calabaza-50 transition-all group">
                ...
                <a href="<?php echo e(route('admin.recetas.index', ['estado' => 'pendiente'])); ?>" class="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-200 hover:border-calabaza-300 hover:bg-calabaza-50 transition-all group">
                    <div class="bg-calabaza-100 p-3 rounded-full mb-2 group-hover:bg-calabaza-200 transition-colors">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/dashboard/dashboard.blade.php ENDPATH**/ ?>