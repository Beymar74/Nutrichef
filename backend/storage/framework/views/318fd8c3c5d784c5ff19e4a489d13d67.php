    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-30 w-64 bg-ambar-800 text-white transition-transform duration-300 ease-in-out -translate-x-full lg:translate-x-0 lg:static flex flex-col shadow-2xl lg:shadow-none border-r border-ambar-900">
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto custom-scrollbar">
                ...
                <!-- Comentarios -->
                <a href="<?php echo e(route('admin.comentarios.index')); ?>" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all group 
                   <?php echo e(request()->routeIs('admin.comentarios.*') ? 'bg-calabaza-600 text-white shadow-md shadow-calabaza-900/20 transform hover:-translate-y-0.5' : 'text-ambar-50 hover:bg-ambar-900/50 hover:text-white'); ?>">
                    <i data-lucide="message-square" class="w-5 h-5 <?php echo e(request()->routeIs('admin.comentarios.*') ? '' : 'group-hover:text-calabaza-500 transition-colors'); ?>"></i>
                    <span>Comentarios</span>
                </a>
                
                <!-- Planificación -->
                <a href="<?php echo e(route('admin.planificacion.index')); ?>" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all group 
                   <?php echo e(request()->routeIs('admin.planificacion.*') ? 'bg-calabaza-600 text-white shadow-md shadow-calabaza-900/20 transform hover:-translate-y-0.5' : 'text-ambar-50 hover:bg-ambar-900/50 hover:text-white'); ?>">
                    <i data-lucide="calendar" class="w-5 h-5 <?php echo e(request()->routeIs('admin.planificacion.*') ? '' : 'group-hover:text-calabaza-500 transition-colors'); ?>"></i>
                ...
                <a href="<?php echo e(route('admin.configuracion.index')); ?>" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all group 
                   <?php echo e(request()->routeIs('admin.configuracion.*') ? 'bg-calabaza-600 text-white shadow-md shadow-calabaza-900/20 transform hover:-translate-y-0.5' : 'text-ambar-50 hover:bg-ambar-900/50 hover:text-white'); ?>">
                    <i data-lucide="settings" class="w-5 h-5 <?php echo e(request()->routeIs('admin.configuracion.*') ? '' : 'group-hover:text-calabaza-500 transition-colors'); ?>"></i>
