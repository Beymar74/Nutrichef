...
<?php $__env->startSection('titulo', 'Revisión de Solicitud'); ?>
...
<?php $__env->startSection('contenido'); ?>
    ...
    <div class="mb-6">
        <a href="<?php echo e(route('admin.solicitudes.index')); ?>" class="text-slate-500 hover:text-calabaza-600 flex items-center gap-1 text-sm font-medium mb-4 transition-colors w-fit">
        ...
        <div class="md:col-span-2 space-y-6">
            <div class="bg-white p-8 rounded-xl shadow-sm border border-slate-100">
                ...
                <div class="flex justify-between items-start mb-6">
                    ...
                    ?>
                    <span class="px-4 py-1.5 rounded-full text-sm font-semibold border <?php echo e($config['clase']); ?> shadow-sm">
                ...
                <div class="bg-slate-50 rounded-xl p-6 mb-6 border border-slate-100">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-slate-800"><?php echo e($solicitud->usuario->name ?? 'Desconocido'); ?></h3>
                            <p class="text-sm text-slate-500"><?php echo e($solicitud->usuario->email ?? ''); ?></p>
                            <p class="text-xs text-slate-400 mt-1">
                                <i data-lucide="calendar" class="w-3 h-3 inline"></i> 
                                Solicitud enviada el <?php echo e($solicitud->created_at->format('d/m/Y H:i')); ?>
                ...
                <div class="mb-6">
                    ...
                    <div class="bg-slate-50 rounded-xl p-5 border border-slate-100">
                        <p class="text-slate-700 leading-relaxed">
                            <?php echo e($solicitud->motivo ?? 'No especificado'); ?>
                ...
                <div class="mb-6">
                    ...
                    <div class="bg-slate-50 rounded-xl p-5 border border-slate-100">
                        <p class="text-slate-700 leading-relaxed">
                            <?php echo e($solicitud->experiencia); ?>
                ...
                <?php if($solicitud->comentario_admin): ?>
                <div class="mb-6">
                    <h3 class="text-lg font-bold text-slate-800 mb-3 flex items-center gap-2">
                    ...
                    <div class="bg-blue-50 rounded-xl p-5 border border-blue-200">
                        <p class="text-slate-700 leading-relaxed italic">
                            "<?php echo e($solicitud->comentario_admin); ?>"
                        </p>
                        <?php if($solicitud->revisor): ?>
                            <p class="text-xs text-slate-500 mt-3">
                                — Revisado por <strong><?php echo e($solicitud->revisor->name); ?></strong> 
                                el <?php echo e($solicitud->fecha_revision?->format('d/m/Y H:i')); ?>
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg border border-calabaza-100 sticky top-24">
                ...
                <?php if($estaPendiente): ?>
                    ...
                    <div class="space-y-3">
                        ...
                        <!-- Botón APROBAR -->
                        <form action="<?php echo e(route('admin.solicitudes.approve', $solicitud->id)); ?>" method="POST" id="approveForm">
                            <?php echo csrf_field(); ?>
                            <textarea 
                        ...
                        <div id="rejectForm" class="hidden mt-4 pt-4 border-t border-slate-100">
                            <form action="<?php echo e(route('admin.solicitudes.reject', $solicitud->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal-confirm','data' => ['id' => 'deleteModal','title' => 'Eliminar Solicitud','message' => '¿Estás seguro? Esta acción eliminará permanentemente la solicitud.','action' => '#','confirmText' => 'Sí, eliminar']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'deleteModal','title' => 'Eliminar Solicitud','message' => '¿Estás seguro? Esta acción eliminará permanentemente la solicitud.','action' => '#','confirmText' => 'Sí, eliminar']); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/solicitudes-chef/show.blade.php ENDPATH**/ ?>